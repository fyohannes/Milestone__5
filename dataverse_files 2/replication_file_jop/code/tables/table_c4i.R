...
mod_fem1 <- lm(v744a_f2012 ~ woman_win + v744a_f2007, data = constituency_data)
mod_fem2 <- lm(v744b_f2012 ~ woman_win + v744b_f2007, data = constituency_data)
mod_fem3 <- lm(v744c_f2012 ~ woman_win + v744c_f2007, data = constituency_data)
mod_fem4 <- lm(v744d_f2012 ~ woman_win + v744d_f2007, data = constituency_data)
mod_fem5 <- lm(v744e_f2012 ~ woman_win + v744e_f2007, data = constituency_data)
mod_fem7 <- lm(add_index_f2012 ~ woman_win + add_index_f2007, data = constituency_data)
...
write_latex_placebo(table[-c(18, 21, 24, 27, 30, 33, 36, 39, 45)], note_text, './outputs/tables/table_female_respondents_lagged.tex', .8)
